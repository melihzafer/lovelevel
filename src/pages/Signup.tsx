      ...
      >
        ...
        <div className="backdrop-blur-xl bg-white/40 dark:bg-black/40 border border-white/40 dark:border-white/10 rounded-3xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1 ml-1">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white shadow-lg shadow-pink-500/30 border-none rounded-xl py-3 font-bold text-lg mt-4"
            >
          ...
          <p className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/login" className="text-pink-600 dark:text-pink-400 hover:text-pink-700 dark:hover:text-pink-300 font-bold underline transition-colors">
