...
export const translations = {
  en: {
    ...
    petNameTooShort: 'Name must be at least 2 characters',
    petNameTooLong: 'Name must be 20 characters or less',
    petNameInvalidChars: 'Only letters, numbers, and spaces allowed',
    inventory: 'Inventory',
    petInventory: 'Pet Inventory',
    equip: 'Equip',
    unequip: 'Unequip',
    equipped: 'Equipped',
    items: 'Items',
    ...
    upcomingNotifications: 'Upcoming Reminders',
    ...
    notificationError: 'Failed to enable notifications',
  ...
  tr: {
    ...
    renamePet: 'Evcil Hayvanı Yeniden Adlandır',
    enterPetName: 'Evcil hayvan ismini girin',
    petNameTooShort: 'İsim en az 2 karakter olmalı',
    petNameTooLong: 'İsim en fazla 20 karakter olabilir',
    petNameInvalidChars: 'Sadece harf, rakam ve boşluk kullanılabilir',
    inventory: 'Envanter',
    petInventory: 'Evcil Hayvan Envanteri',
    equip: 'Kuşan',
    unequip: 'Çıkar',
    equipped: 'Kuşanılmış',
    items: 'Eşyalar',
    ...
    upcomingNotifications: 'Yaklaşan Hatırlatıcılar',
    notificationsNotSupported: 'Bu tarayıcıda bildirimler desteklenmiyor',
    notificationsDenied: 'Bildirimler engellenmiş. Lütfen tarayıcı ayarlarından etkinleştirin',
    notificationError: 'Bildirimler etkinleştirilemedi',
  ...
  bg: {
    ...
    petLevel: 'Ниво',
    rename: 'Преименувай',
    renamePet: 'Преименувай домашен любимец',
    enterPetName: 'Въведете име на домашен любимец',
    petNameTooShort: 'Името трябва да има поне 2 символа',
    petNameTooLong: 'Името може да има до 20 символа',
    petNameInvalidChars: 'Само букви, цифри и интервали са позволени',
    inventory: 'Инвентар',
    petInventory: 'Инвентар на домашен любимец',
    equip: 'Екипирай',
    unequip: 'Свали',
    equipped: 'Екипирано',
    items: 'Предмети',
    ...
    enabled: 'Активирани',
    denied: 'Отказани',
    testNotification: 'Изпрати тестово известие',
    upcomingNotifications: 'Предстоящи напомняния',
    notificationsNotSupported: 'Известията не се поддържат в този браузър',
    notificationsDenied: 'Известията са блокирани. Моля, активирайте ги от настройките на браузъра',
    notificationError: 'Неуспешно активиране на известията',
