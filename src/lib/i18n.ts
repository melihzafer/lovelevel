...
export const translations = {
  en: {
    ...
    connectDescription: 'Invite your partner or join using their code',
    ...
    challengesAndPetSynced: 'Challenges and pet synced automatically',
    disconnectPartner: 'Disconnect Partner',
    disconnecting: 'Disconnecting',
    confirmDisconnectPartner: 'Are you sure you want to disconnect from your partner?',
    errorDisconnectingPartner: 'Failed to disconnect. Please try again.',
    partnershipFeatures: 'Partnership Features',
    featureSharedChallenges: 'Shared challenges and progress',
    featurePetSync: 'Pet status synchronization',
    featureCombinedStats: 'Combined stats and history',
    featureRealTimeUpdates: 'Real-time updates',
    
    // Invite Partner
    inviteYourPartner: 'Invite Your Partner',
    shareCodeWithPartner: 'Share this code with your partner to connect',
    ...
    noActiveInviteCode: 'No active invite code',
    generateInviteCode: 'Generate Invite Code',
    generating: 'Generating',
    tips: 'Tips',
    inviteTip1: 'Code expires in 7 days',
    inviteTip2: 'Only one person can use this code',
    inviteTip3: 'Generate a new code if needed',
    
    // Join Partner
    joinYourPartner: 'Join Your Partner',
    enterInviteCodeFromPartner: 'Enter the invite code from your partner',
    inviteCode: 'Invite Code',
    cannotUseOwnCode: 'You cannot use your own invite code',
    ...
    nowConnectedWith: 'You are now connected with',
    refreshingPage: 'Refreshing page',
    wantsToConnectWithYou: 'wants to connect with you',
    acceptAndConnect: 'Accept & Connect',
    connecting: 'Connecting',
    inviteCodeHelp: 'Ask your partner for their 6-character invite code',
  ...
  tr: {
    ...
    daysTogether: 'Birlikte Geçen Günler',
    months: 'Ay',
    years: 'Yıl',
    ...
    // Partner System
    connectWithPartner: 'Partnerinizle Bağlanın',
    connectDescription: 'Partnerinizi davet edin veya onların koduyla katılın',
    invitePartner: 'Partner Davet Et',
    joinPartner: 'Partnere Katıl',
    yourPartnership: 'Partnerliğiniz',
    anniversaryDate: 'Yıldönümü',
    realTimeSyncActive: 'Anlık Senkronizasyon Aktif',
    challengesAndPetSynced: 'Zorluklar ve evcil hayvan otomatik senkronize ediliyor',
    disconnectPartner: 'Partner Bağlantısını Kes',
    disconnecting: 'Bağlantı Kesiliyor',
    confirmDisconnectPartner: 'Partnerinizle bağlantıyı kesmek istediğinizden emin misiniz?',
    errorDisconnectingPartner: 'Bağlantı kesilemedi. Lütfen tekrar deneyin.',
    partnershipFeatures: 'Partnerlik Özellikleri',
    featureSharedChallenges: 'Paylaşılan zorluklar ve ilerleme',
    featurePetSync: 'Evcil hayvan durumu senkronizasyonu',
    featureCombinedStats: 'Birleşik istatistikler ve geçmiş',
    featureRealTimeUpdates: 'Anlık güncellemeler',
    
    // Invite Partner
    inviteYourPartner: 'Partnerinizi Davet Edin',
    shareCodeWithPartner: 'Bağlanmak için bu kodu partnerinizle paylaşın',
    ...
    noActiveInviteCode: 'Aktif davet kodu yok',
    generateInviteCode: 'Davet Kodu Oluştur',
    generating: 'Oluşturuluyor',
    tips: 'İpuçları',
    inviteTip1: 'Kod 7 gün içinde sona erer',
    inviteTip2: 'Bu kodu sadece bir kişi kullanabilir',
    inviteTip3: 'Gerekirse yeni bir kod oluşturun',
    
    // Join Partner
    joinYourPartner: 'Partnerinize Katılın',
    enterInviteCodeFromPartner: 'Partnerinizin davet kodunu girin',
    inviteCode: 'Davet Kodu',
    cannotUseOwnCode: 'Kendi davet kodunuzu kullanamazsınız',
    invalidInviteCode: 'Geçersiz veya süresi dolmuş davet kodu',
    failedToAcceptInvite: 'Davet kabul edilemedi',
    partnershipCreated: 'Partnerlik Oluşturuldu!',
    nowConnectedWith: 'Artık şununla bağlantıdasınız',
    refreshingPage: 'Sayfa yenileniyor',
    wantsToConnectWithYou: 'sizinle bağlantı kurmak istiyor',
    acceptAndConnect: 'Kabul Et & Bağlan',
    connecting: 'Bağlanıyor',
    inviteCodeHelp: 'Partnerinizden 6 karakterlik davet kodunu isteyin',
  ...
  bg: {
    ...
    // Partner System
    connectWithPartner: 'Свържете се с партньор',
    connectDescription: 'Поканете вашия партньор или се присъединете с техния код',
    invitePartner: 'Покани партньор',
    joinPartner: 'Присъедини се към партньор',
    yourPartnership: 'Вашето партньорство',
    anniversaryDate: 'Годишнина',
    realTimeSyncActive: 'Синхронизация в реално време активна',
    challengesAndPetSynced: 'Предизвикателствата и домашният любимец се синхронизират автоматично',
    disconnectPartner: 'Прекъсни връзката с партньор',
    disconnecting: 'Прекъсване',
    confirmDisconnectPartner: 'Сигурни ли сте, че искате да прекъснете връзката с партньора си?',
    errorDisconnectingPartner: 'Неуспешно прекъсване. Моля, опитайте отново.',
    partnershipFeatures: 'Функции на партньорството',
    featureSharedChallenges: 'Споделени предизвикателства и прогрес',
    featurePetSync: 'Синхронизация на състоянието на домашния любимец',
    featureCombinedStats: 'Комбинирани статистики и история',
    featureRealTimeUpdates: 'Актуализации в реално време',
    
    // Invite Partner
    inviteYourPartner: 'Поканете вашия партньор',
    shareCodeWithPartner: 'Споделете този код с партньора си, за да се свържете',
    ...
    shareCode: 'Сподели код',
    generateNewCode: 'Генерирай нов код',
    noActiveInviteCode: 'Няма активен код за покана',
    generateInviteCode: 'Генерирай код за покана',
    generating: 'Генериране',
    tips: 'Съвети',
    inviteTip1: 'Кодът изтича след 7 дни',
    inviteTip2: 'Само един човек може да използва този код',
    inviteTip3: 'Генерирайте нов код, ако е необходимо',
    
    // Join Partner
    joinYourPartner: 'Присъединете се към партньора си',
    enterInviteCodeFromPartner: 'Въведете кода за покана от вашия партньор',
    inviteCode: 'Код за покана',
    cannotUseOwnCode: 'Не можете да използвате собствения си код за покана',
    invalidInviteCode: 'Невалиден или изтекъл код за покана',
    failedToAcceptInvite: 'Неуспешно приемане на поканата',
    partnershipCreated: 'Партньорството е създадено!',
    nowConnectedWith: 'Сега сте свързани с',
    refreshingPage: 'Опресняване на страницата',
    wantsToConnectWithYou: 'иска да се свърже с вас',
    acceptAndConnect: 'Приеми и свържи',
    connecting: 'Свързване',
    inviteCodeHelp: 'Поискайте от партньора си 6-символния код за покана',
